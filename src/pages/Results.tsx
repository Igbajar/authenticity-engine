        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className={`rounded-2xl border border-border p-6 ${getScoreBg(aiScore)}`}>
              ...
              {(aiScore > 40 || similarityScore > 40) && scan?.documents?.content && (
                <Button
                  variant="hero"
                  size="sm"
              ...
              <div className="rounded-2xl border border-accent/30 bg-accent/5 p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button variant="outline" size="sm" onClick={downloadHumanizedTxt}>
                      <Download className="w-4 h-4 mr-1" /> .txt
                    </Button>
                    <Button variant="outline" size="sm" onClick={downloadHumanizedDocx}>
